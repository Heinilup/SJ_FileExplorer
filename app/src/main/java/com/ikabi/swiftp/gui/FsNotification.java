...
import com.ikabi.apps.view.FtpServerControlFragment;
...
public class FsNotification extends BroadcastReceiver {
    ...
    private void setupNotification(Context context) {
        ...
        Intent notificationIntent = new Intent(context, FtpServerControlFragment.class);
        ...
        CharSequence stopText = context.getString(R.string.stop_server);
