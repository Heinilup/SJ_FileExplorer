...
package com.ikabi.swiftp.server;

import android.util.Log;

import com.ikabi.swiftp.Defaults;
import com.ikabi.swiftp.FsService;
import com.ikabi.swiftp.FsSettings;
...
public class SessionThread extends Thread {
    ...
    protected com.ikabi.swiftp.server.LocalDataSocket localDataSocket;
    ...
    public SessionThread(Socket socket, com.ikabi.swiftp.server.LocalDataSocket dataSocket) {
        ...
        try {
            ...
            while (true) {
                ...
                if (line != null) {
                    ...
                    com.ikabi.swiftp.server.FtpCmd.dispatchCommand(this, line);
                } else {
