...
import com.ikabi.apps.slidingmenu.SlidingMenu;
import com.ikabi.apps.ui.base.BaseSlidingFragmentActivity;
	...
	public final void setShowSelFragments(MenuItemType menutype) {
		...
		switch (menutype) {
			...
			case MENU_MUSIC:
				...
				break;
			case MENU_FAVORITE1:
				setTitle(getString(R.string.favorite1));
				setFileNum((int) mSlidingMenuFragment.getFilenum(FileCategoryType.Favorite), mCurrentmenuItemType);
				mFileCategoryFragment.onCategorySelected(FileCategoryType.Favorite);
				break;
			default:
				break;
