...
import com.ikabi.apps.entity.MediaFile;
import com.ikabi.apps.entity.MediaFile.MediaFileType;
...
public class FileCategoryHelper {
	...
	public enum FileCategoryType {
		All, Music, Video, Picture, Theme, Doc, Zip, Apk, Custom, Other, Favorite, Favorite1
	}
	...
	public static HashMap<FileCategoryType, com.ikabi.apps.apis.FilenameExtFilter> filters = new HashMap<FileCategoryType, com.ikabi.apps.apis.FilenameExtFilter>();
	...
	static {
		...
		categoryNames.put(FileCategoryType.Favorite1, R.string.category_fav);
